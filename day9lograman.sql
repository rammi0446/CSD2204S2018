...
MariaDB [csd2204s18]> desc region;
ERROR 1146 (42S02): Table 'csd2204s18.region' doesn't exist
...
MariaDB [csd2204s18]> select department_id,first_name,last_name  from departments where department_name like 'IT%';
ERROR 1054 (42S22): Unknown column 'first_name' in 'field list'
MariaDB [csd2204s18]> select department_id,first_name,last_name  from employees where department_id=(select depratment_id from departments where department_name like 'It%';
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near '' at line 1
MariaDB [csd2204s18]> select department_id,first_name,last_name  from employees where department_id=(select depratment_id from departments where department_name like 'It%');
ERROR 1054 (42S22): Unknown column 'depratment_id' in 'field list'
MariaDB [csd2204s18]> select department_id,first_name,last_name  from employees where department_id=(select department_id from departments where department_name like 'It%');
ERROR 1242 (21000): Subquery returns more than 1 row
MariaDB [csd2204s18]> select department_id,first_name,last_name  from employees where department_id IN(select department_id from departments where department_name like 'It%');
+---------------+------------+-----------+
...
MariaDB [csd2204s18]> select * from location;
...
MariaDB [csd2204s18]> select loaction_id,country_id from locations where country_id='us';
ERROR 1054 (42S22): Unknown column 'loaction_id' in 'field list'
...
MariaDB [csd2204s18]> select manager_id from employees;
+------------+
| manager_id |
+------------+
|          0 |
...
MariaDB [csd2204s18]> select * from employess;
...
MariaDB [csd2204s18]> select job_id,min_salary from jobs where job_id in(select job_id,salary from employees);
...
MariaDB [csd2204s18]> select first_name,last_name,salary,job_id from employees where job_id in(select job_id,min_salary from jobs);
ERROR 1241 (21000): Operand should contain 1 column(s)
MariaDB [csd2204s18]> select first_name,last_name,salary,job_id from employees where job_id in(select min_salary from jobs);
Empty set, 2033 warnings (0.01 sec)

MariaDB [csd2204s18]> select first_name,last_name,salary,job_id from employees where job_id in(select job_id from jobs);
+-------------+-------------+----------+------------+
| first_name  | last_name   | salary   | job_id     |
+-------------+-------------+----------+------------+
| Steven      | King        | 24000.00 | AD_PRES    |
